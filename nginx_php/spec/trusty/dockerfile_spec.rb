...
describe command("docker -H ':5432' exec app1 openssl sha1 /etc/monit/conf.d/nginx.conf | awk '{print $NF}'") do
...
describe command("docker -H ':5432' exec app1 openssl sha1 /etc/nginx/nginx.conf | awk '{print $NF}'") do
...
describe command("docker -H ':5432' exec app1 openssl sha1 /etc/nginx/sites-available/app1 | awk '{print $NF}'") do
...
describe command("docker -H ':5432' exec app1 test -f /etc/monit/conf.d/php5fpm.conf") do
...
describe command("docker -H ':5432' exec app1 openssl sha1 /etc/monit/conf.d/php5fpm.conf | awk '{print $NF}'") do
...
describe command("docker -H ':5432' exec app1 test -f /etc/php5/fpm/php.ini") do
...
describe command("docker -H ':5432' exec app1 php5-fpm -m") do
...
describe command("docker -H ':5432' exec app1 php5-fpm -i") do
